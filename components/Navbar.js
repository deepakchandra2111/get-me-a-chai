  ...
  return (
    <nav className='bg-gray-900 text-white flex justify-between px-4 items-center md:h-16 flex-col md:flex-row'>
      ...
      <div className='relative flex flex-col md:flex-row gap-4'>
        ...
        }} id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="mx-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Welcome {session.user.email} <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
        ...
        <div className='flex flex-row md:block justify-center'>
